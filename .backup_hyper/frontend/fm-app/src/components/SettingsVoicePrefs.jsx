...
export default function SettingsVoicePrefs() {
  ...
  return (
    <div className="fr-card p-4">
      <div className="font-semibold mb-2 text-fr-text">🎙️ Voice-Defaults (Leads)</div>
      <div className="text-sm text-fr-muted mb-3">
        Standard-Verhalten bei "Such Leads …" Voice-Commands
      </div>
      ...
      <div className="text-xs text-fr-muted mt-2">
        ...
        <strong>Nur anlegen:</strong> Leads direkt in Queue (ohne Outreach)<br />
        <strong>Direkt anschreiben:</strong> Leads suchen + direkt anschreiben (wenn erlaubt)
      </div>
    </div>
  );
}

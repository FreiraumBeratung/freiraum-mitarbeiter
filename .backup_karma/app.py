...
# Health Router früh einbinden (vor anderen Routers)
try:
    from .routers.health import router as health_router_new
    app.include_router(health_router_new)
except Exception as e:
    log.warning(f"Health router aus routers/health konnte nicht geladen werden: {e}")

...
try:
    from app.routers import health_ready as _health_ready
    ...
    try:
        ...
        log.warning(f"Health & Readiness router konnte nicht geladen werden: {e2}")

# UI Router
try:
    from app.routers import ui as _ui
    app.include_router(_ui.router, prefix="/api")
except Exception as e:
    try:
        from .routers import ui as _ui
        app.include_router(_ui.router, prefix="/api")
    except Exception as e2:
        log.warning(f"UI router konnte nicht geladen werden: {e2}")

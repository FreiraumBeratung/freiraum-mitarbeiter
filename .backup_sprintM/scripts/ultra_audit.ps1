...
# Offer Draft variants to try (any should pass now):
# v1
$offer1 = @{ customer="Test GmbH"; items=@(@{ name="Beratung"; qty="2"; unit_price="120" }) }
# v2
$offer2 = @{ items=@(@{ title="Beratung"; quantity="1"; price="99.9" }) }
# v3 (single item under 'item')
$offer3 = @{ customer_id="1"; item=@{ title="Service"; quantity=1; price=0 } }
...
# Character Event variants:
$ce1 = @{ user_id="denis"; text="Audit event ok"; sentiment="neutral"; topics="offers,leads" }
$ce2 = @{ user="denis"; message="Hallo Welt"; mood="positive"; topics=@("sales","kpi") }
...
# KB Create variants:
$kb1 = @{ title="Audit Note"; body="OK"; tags="audit,auto" }
$kb2 = @{ topic="Wissensnotiz"; content="Body"; tags=@("kb","info") }
